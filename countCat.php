...
$sesID = $_GET['sesID']; // Replace this with the actual method you use to get staffID

// Fetch data and count categories
$query = "
    SELECT recevCol, COUNT(*) AS count FROM request WHERE sesID = '$sesID' GROUP BY recevCol
";
